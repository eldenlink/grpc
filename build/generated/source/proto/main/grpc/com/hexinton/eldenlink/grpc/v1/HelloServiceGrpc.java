...
/**
 * <pre>
 * Simple Hello service for testing gRPC
 * </pre>
 */
@javax.annotation.Generated(
    value = "by gRPC proto compiler (version 1.68.2)",
    comments = "Source: eldenlink/v1/hello.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class HelloServiceGrpc {

  private HelloServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "eldenlink.v1.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest,
      com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.hexinton.eldenlink.grpc.v1.HelloRequest.class,
      responseType = com.hexinton.eldenlink.grpc.v1.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest,
      com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest, com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.hexinton.eldenlink.grpc.v1.HelloRequest, com.hexinton.eldenlink.grpc.v1.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hexinton.eldenlink.grpc.v1.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hexinton.eldenlink.grpc.v1.HelloResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest,
      com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest,
      com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloStreamMethod() {
    io.grpc.MethodDescriptor<com.hexinton.eldenlink.grpc.v1.HelloRequest, com.hexinton.eldenlink.grpc.v1.HelloResponse> getSayHelloStreamMethod;
    if ((getSayHelloStreamMethod = HelloServiceGrpc.getSayHelloStreamMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloStreamMethod = HelloServiceGrpc.getSayHelloStreamMethod) == null) {
          HelloServiceGrpc.getSayHelloStreamMethod = getSayHelloStreamMethod =
              io.grpc.MethodDescriptor.<com.hexinton.eldenlink.grpc.v1.HelloRequest, com.hexinton.eldenlink.grpc.v1.HelloResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hexinton.eldenlink.grpc.v1.HelloResponse.getDefaultInstance()))
              .setSchemaDescriptor(new HelloServiceMethodDescriptorSupplier("SayHelloStream"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(com.hexinton.eldenlink.grpc.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSayHelloMethod(), responseObserver);
    }

    /**
     * <pre>
     * Server streaming - say hello multiple times
     * </pre>
     */
    default void sayHelloStream(com.hexinton.eldenlink.grpc.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
     ...
     * </pre>
     */
    public void sayHello(com.hexinton.eldenlink.grpc.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse> responseObserver) {
     ...
     * </pre>
     */
    public void sayHelloStream(com.hexinton.eldenlink.grpc.v1.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
     ...
     * </pre>
     */
    public com.hexinton.eldenlink.grpc.v1.HelloResponse sayHello(com.hexinton.eldenlink.grpc.v1.HelloRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.hexinton.eldenlink.grpc.v1.HelloResponse> sayHelloStream(
        com.hexinton.eldenlink.grpc.v1.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hexinton.eldenlink.grpc.v1.HelloResponse> sayHello(
        com.hexinton.eldenlink.grpc.v1.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.hexinton.eldenlink.grpc.v1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse>) responseObserver);
          break;
        case METHODID_SAY_HELLO_STREAM:
          serviceImpl.sayHelloStream((com.hexinton.eldenlink.grpc.v1.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hexinton.eldenlink.grpc.v1.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.hexinton.eldenlink.grpc.v1.HelloRequest,
              com.hexinton.eldenlink.grpc.v1.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hexinton.eldenlink.grpc.v1.Hello.getDescriptor();
    }
